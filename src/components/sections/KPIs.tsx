...
export function KPIs() {
  const kpis = [
    {
      ...
      description: "Direct contribution of SEO to business growth",
    ...
    },
    {
      ...
      description: "Demand captured across priority categories",
    ...
    },
    {
      ...
      description: "Visibility against key competitors",
    ...
    },
    {
      ...
      description: "Revenue-driving pages successfully indexed",
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-bold tracking-tight text-zinc-900 mb-4" suppressHydrationWarning>Visual KPI Dashboard</h2>
        <p className="text-lg text-zinc-600 font-medium">
          Success will be measured through a single North Star metric supported by leading indicators.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {kpis.map((kpi, i) => (
          <div key={i} className="p-6 border border-zinc-200 rounded-2xl bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:border-zinc-300 group flex flex-col justify-start">
