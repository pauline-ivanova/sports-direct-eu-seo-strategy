  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h2 className="text-3xl font-bold tracking-tight text-zinc-900" suppressHydrationWarning>The Foundation</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        <div className="lg:col-span-7 flex flex-col gap-3">
          <div className="grid grid-cols-2 gap-3">
            <div className="p-4 border border-zinc-200 rounded-2xl bg-white transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:border-zinc-300 flex flex-col justify-center">
            ...
            <div className="col-span-2 p-4 border border-zinc-200 rounded-2xl bg-white shadow-sm flex flex-row items-center justify-between transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:border-zinc-300">
