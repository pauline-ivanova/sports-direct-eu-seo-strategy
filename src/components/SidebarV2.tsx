...
const NAV_ITEMS = [
  ...
  { id: "core-focus", label: "Our Focus" },
  { id: "foundation", label: "Where We Are" },
  { id: "market-landscape", label: "The Market" },
  { id: "market-reality", label: "Insights" },
  { id: "philosophy", label: "How I Work" },
  { id: "four-pillars", label: "4 Steps" },
  { id: "pillar-1", label: "Step 1: Fix It" },
  { id: "pillar-2", label: "Step 2: Show It" },
  { id: "pillar-3", label: "Step 3: UK Focus" },
  { id: "pillar-4", label: "Step 4: Sell It" },
  { id: "roadmap", label: "The Plan" },
  { id: "kpis", label: "Goals" },
